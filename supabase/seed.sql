...
values
  ...
  ('Freedom in God', 'episode-5', '936060669', '0ef229015d', 5, true),
  ('The Church', 'episode-6', '936060756', 'cb56cb3498', 6, true),
  ('Prayer', 'episode-7', '936060888', '762dd81b5d', 7, true),
  ('Water Baptism', 'episode-8', '936061060', '3817f3b520', 8, true),
  -- TODO: confirm Episode 9's title with Shannon (only 8 titles supplied so far)
